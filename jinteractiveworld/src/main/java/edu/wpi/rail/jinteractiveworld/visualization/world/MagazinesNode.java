...
/**
 * The magazines visualization node.
 * 
 * @author Russell Toris -- rctoris@wpi.edu
 * @version March 3, 2014
 */
@SuppressWarnings("serial")
public class MagazinesNode extends PNode {
	...
	/**
	 * Create a new magazines node for the visualization.
	 */
	public MagazinesNode() {
		...
		// create the label
		PText text = new PText(m.getName());
